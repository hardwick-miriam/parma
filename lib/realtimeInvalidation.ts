...
export const TABLE_QUERY_KEYS: Record<string, string[]> = {
  ...
  mounjaro_doses: ['mounjaro-due', 'mounjaro-history', 'mood-correlations'],
  mounjaro_effects: ['mounjaro-due', 'mounjaro-history'],
  media_log: ['media'],
  wardrobe_items: ['wardrobe', 'wardrobe-item'],
  wardrobe_wears: ['wardrobe', 'wardrobe-item'],
  journal_notes: ['journal-summary', 'journal-notes'],
  user_preferences: ['main-summary', 'health-summary', 'body-summary', 'gym-summary', 'user-preferences', 'visited-countries', 'world-clocks'],
