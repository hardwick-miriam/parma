...
const DEFAULT_SM: LayoutItem[] = [
  ...
  { i: 'work',    x: 0, y: 18, w: 4, h: 5 },
  { i: 'weather', x: 0, y: 23, w: 4, h: 5 },
  { i: 'hab',     x: 0, y: 28, w: 4, h: 5 },
  { i: 'media',   x: 0, y: 33, w: 4, h: 5 },
  { i: 'supp',    x: 0, y: 38, w: 4, h: 5 },
  { i: 'photos',  x: 0, y: 43, w: 4, h: 5 },
  { i: 'journal', x: 0, y: 48, w: 4, h: 5 },
  { i: 'map',     x: 0, y: 53, w: 4, h: 5 },
  { i: 'clocks',  x: 0, y: 58, w: 4, h: 4 },
  { i: 'whoop',   x: 0, y: 62, w: 4, h: 5 },
  { i: 'insights',  x: 0, y: 67, w: 4, h: 5 },
  { i: 'body',        x: 0, y: 72, w: 4, h: 9 },
  { i: 'prtracker',   x: 0, y: 81, w: 4, h: 5 },
  { i: 'trainload',   x: 0, y: 86, w: 4, h: 5 },
